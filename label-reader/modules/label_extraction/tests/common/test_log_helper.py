"""Test src/common/test_log_helper."""
import unittest
from unittest.mock import patch
from unittest import mock
import os
import src.common.log_helper as log_helper


class TestLogHelper(unittest.TestCase):
    @patch("src.common.log_helper.app_insights_key", "")
    def test_get_logger_disabled(self):
        logger = log_helper.get_logger()
        assert logger is not None

    @patch("src.common.log_helper.app_insights_key", "test")
