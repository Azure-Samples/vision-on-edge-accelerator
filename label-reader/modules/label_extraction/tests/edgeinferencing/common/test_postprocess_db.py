...
import numpy as np
from src.edgeinferencing.config import DBPostProcessConfig
...
class TestDBPostProcess(unittest.TestCase):
    ...
    def test_create_db_post_process_if_created_successfully(self):
        config = DBPostProcessConfig(0.1, 0.1, 1, 1, True, "fast")
        dp_process = DBPostProcess(
        ...
        self.assert_(dp_process is not None)
